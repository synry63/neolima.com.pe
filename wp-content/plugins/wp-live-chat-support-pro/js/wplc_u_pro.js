...
jQuery(document).ready(function() {
    ...
    jQuery('#wp-live-chat [placeholder]').focus(function() {
        ...
        function open_chat(){
            ...
            wplc_chat_status = parseInt(jQuery.cookie('wplc_chat_status'));
...
//                        jQuery("#wplc_email").val(jQuery.cookie('wplc_email'));
        ...
        jQuery("body").on("click", "#wplc_start_chat_btn", function() {
            ...
            if(jQuery("#wplc_email").attr('wplc_hide') !== "1"){
                if (wplc_name.length <= 0) { alert("Por favor, escriba su nombre"); return false; }
                if (wplc_email.length <= 0) { alert("Por favor, introduzca su dirección de correo electrónico"); return false; }
                var testEmail = /^[A-Z0-9._%+-]+@([A-Z0-9-]+\.)+[A-Z]{2,4}$/i;
                if (!testEmail.test(wplc_email)){
                    alert("Por favor, introduce una dirección de correo electrónico válida"); return false;
                }
            }
        ...
        jQuery("body").on("click", "#wplc_na_msg_btn", function() {
            ...
            if (wplc_msg.length <= 0) { alert("Por favor, introduzca un mensaje"); return false; }
