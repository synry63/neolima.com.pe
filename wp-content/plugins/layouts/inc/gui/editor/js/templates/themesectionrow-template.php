<script type="text/html" id="themesectionrow-template">
	...
	<div class="row-toolbar js-row-toolbar">
		...
		<div class="row-actions js-row-actions">
			<i class="icon-pencil js-row-edit js-row-edit-icon" data-tooltip-text="<?php _e('Edit row', 'ddl-layouts'); ?>"></i>
			<i class="icon-remove icon-remove-enabled js-row-remove js-row-remove-icon" data-tooltip-text="<?php _e('Remove row', 'ddl-layouts'); ?>"></i>
		</div>
	</div>
