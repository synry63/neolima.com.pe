                                    ...
                                    <# data.value = 'duplicate'#> class="select-layout-action-in-listing-page
                                        ...
                                        <#    }
                                            ...
                                            <#
                                                ...
                                                <span class="restore"><a <# data.value = "change"#>
                                                        class="select-layout-action-in-listing-page
                ...
                <#
                    ...
                    <#
                        ...
                        <li>{{{ ' '+v.label+' ' }}}<span class="js-alret-icon-hide-post"><a
                                    ...
                                    class="apply-for-all js-apply-layout-for-all-posts-js js-alert-icon-hide-{{{ v.type }}} button button-small button-leveled icon-warning-sign js-apply-for-all-posts js-alret-icon-hide-post"> <?php _e('Use this layout for ', 'ddl-layouts'); ?>
        ...
        <# if( show_used_on ){ #>
            <td class="column-used-on {{{ used_on_class }}}">
                ...
                <#
                    ...
                    var class_up_or_down = ddl.show_posts == -1 ? 'icon-caret-up' : 'icon-caret-down'
                    #>
