...
DDLayout.ViewsInIfame = function ($) {
    ...
    self.fetch_extra_controls = function ( div_id ) {
        ...
        var controls = '';
        controls += '<p>' + $('#ddl-default-edit-cell-name').parent().html() + '</p><br />';
        controls += $('.js-css-styling-controls').html();
		
		var section = '';
		section += '<div id="views-layouts-div" class="wpv-setting-container js-wpv-settings-views-layouts-div">';
		section += '<div class="wpv-settings-header"><h3><i class="icon-layouts-logo ont-color-orange ont-icon-24"></i> ' + DDLayout_settings.DDL_JS.cred_layout_css_text + '</h3></div>';
