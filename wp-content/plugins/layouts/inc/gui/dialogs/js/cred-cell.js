...
DDLayout.CredCell = function($)
{
	...
	var _dialog_close = function _dialog_close(event, content, dialog) {
	...
	var _set_cell_name = function _set_cell_name () {
	...
	var _edit_cred_form = function _edit_cred_form() {
		_cred_open(false);
	}
	
	var _cred_open = function _cred_open(new_form) {
	...
	var _switch_to_new_form_mode = function _switch_to_new_form_mode() {
	...
	var _switch_to_existing_form_mode = function _switch_to_existing_form_mode() {
	...
	var _enable_edit_button = function _enable_edit_button (state) {
	...
	var _create_and_open_cred_form = function _create_and_open_cred_form () {
...
DDLayout.CredInIfame = function($)
{
	...
	self.close_iframe = function (callback) {
		...
		var css = cred_iframe.get_css_settings();
		...
		jQuery('#ddl-default-edit #ddl-default-edit-cell-name').val( css.name );
