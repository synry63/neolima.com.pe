    ...
    class CRED_User_Cell
    {
        ...
        function cred_user_cell_template_callback()
        {
            ...
            <div class="cell-content">
                ...
                <p class="cell-name">{{ name }} &ndash; <?php _e('CRED Form', 'ddl-layouts'); ?></p>
        ...
        function ddl_create_cred_user_form()
        {
            ...
            if (defined('CRED_CLASSES_PATH')) {
                ...
                if ($id) {
                    $result['option'] = $this->ddl_cred_user_get_option_element($id, $_POST['name'], $_POST['mode'], $_POST['post_type']
                    );
                } else {
        ...
        function ddl_cred_user_get_option_element($id, $name, $type, $post_type_name)
        {
