		...
		<ul class="ddl-form">
						...
						<ul>
							...
							<?php if ($views_1_6_available): ?>
								<li class="js-post-content-ct js-ct-selector" style="text-align: right;">
                                    ...
                                    <a href="#" class="js-create-new-ct button button-large"><?php _e('Create a new one', 'ddl-layouts'); ?></a>
								</li>
							<?php endif; ?>
						</ul>
					</div>
			...
			<?php if( $views_1_6_available ): ?>
				<li class="js-post-content-ct js-ct-edit">
					<input class="js-ct-edit-name" type="text" style="float: left; width: 50%" /><span class="js-ct-editing"><strong><?php _e('Editing', 'ddl-layouts'); ?> :</strong> <span class="js-ct-name ct-name-span"></span></span>
                    <a style="float: right" href="#" class="js-load-different-ct button button-large"><?php _e('Load a different Content Template', 'ddl-layouts'); ?></a>
				</li>
				<li class="js-post-content-ct js-ct-edit">
