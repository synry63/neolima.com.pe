    ...
    function row_start_callback( $cssClass, $layout_type = 'fixed', $cssId = '', $additionalCssClasses = '', $tag = 'div', $mode = 'normal') {
        ...
        switch($mode) {
            ...
            case 'full-width-background':
                ...
                ?>
                <<?php echo $tag; ?> class="full-bg <?php if( $additionalCssClasses ) {echo $additionalCssClasses;} ?>"<?php if( $cssId ) { echo ' id="' . $cssId .'"'; }?>>
            ...
            case 'full-width':
                ...
                <<?php echo $tag; ?> class="ddl-full-width-row <?php echo 'row'.$type; if( $additionalCssClasses ) {echo ' '.$additionalCssClasses;} ?>"<?php if( $cssId ) { echo ' id="' . $cssId .'"'; }?>>
                <?php
                break;
...
class WPDD_BootstrapThree_render extends WPDD_layout_render
{
    ...
    function __construct($layout, $child_layout = null){
        ...
        $this->column_prefix = apply_filters('ddl-set-bootstrap-column-prefix', 'col-sm-');
    }
    ...
    function get_class_name_for_width ($width) {
        ...
        $ret = $this->column_prefix.(string)$width;
    ...
    function set_cell_offset_class( )
    {
        ...
        if( $this->offset > 0 )
        {
            $offset_class .= sprintf(' %soffset-%s', $this->column_prefix, (string) $this->offset);
        }
        return $offset_class;
    }
