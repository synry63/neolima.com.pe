...
<?php if ( ! empty( $_POST ) && ! wp_verify_nonce( $_REQUEST['wp_create_nonce'], 'gmwfb-add-nonce' ) )  { die('<p>Security check failed.</p>'); } ?>
<div class="wrap">
<?php
$gmwfb_errors = array();
$gmwfb_success = '';
...
$form = array(
	...
	'gmwfb_zoom' => '',
	'gmwfb_maptype' => '',
	'gmwfb_turnoffscrolling' => '',
	'gmwfb_enablevisualrefresh' => '',
	'gmwfb_imagery' => '',
	'gmwfb_layers' => '',
	'gmwfb_turnoffpan' => '',
	'gmwfb_turnoffzoom' => '',
	'gmwfb_turnoffmaptype' => '',
	'gmwfb_turnoffscale' => '',
	'gmwfb_turnoffstreetview' => '',
	'gmwfb_turnoffoverviewmap' => '',
	'gmwfb_streetview' => ''
);
...
if (isset($_POST['gmwfb_form_submit']) && $_POST['gmwfb_form_submit'] == 'yes')
{
	...
	$form['gmwfb_heading'] = isset($_POST['gmwfb_heading']) ? $_POST['gmwfb_heading'] : '';
	...
	$form['gmwfb_address'] = isset($_POST['googlemap_address']) ? $_POST['googlemap_address'] : '';
	...
	$form['gmwfb_latitude'] = isset($_POST['googlemap_latitude']) ? $_POST['googlemap_latitude'] : '';
	...
	$form['gmwfb_longitude'] = isset($_POST['googlemap_longitude']) ? $_POST['googlemap_longitude'] : '';
	...
	$form['gmwfb_message'] = isset($_POST['gmwfb_message']) ? $_POST['gmwfb_message'] : '';
	$form['gmwfb_width'] = isset($_POST['gmwfb_width']) ? $_POST['gmwfb_width'] : '';
	$form['gmwfb_height'] = isset($_POST['gmwfb_height']) ? $_POST['gmwfb_height'] : '';
	$form['gmwfb_zoom'] = isset($_POST['gmwfb_zoom']) ? $_POST['gmwfb_zoom'] : '';
	$form['gmwfb_maptype'] = isset($_POST['gmwfb_maptype']) ? $_POST['gmwfb_maptype'] : '';
	$form['gmwfb_turnoffscrolling'] = '';
	$form['gmwfb_enablevisualrefresh'] = '';
	$form['gmwfb_imagery'] = '';
	$form['gmwfb_draggable'] = '';
	$form['gmwfb_layers'] = isset($_POST['gmwfb_layers']) ? $_POST['gmwfb_layers'] : '';
	...
	{
		$action = gmwfb_dbquery::gmwfb_act($form, "ins");
		if($action == "sus")
		{
			$gmwfb_success = __('New details was successfully added.', 'google-map-with-fancybox-popup');
		}
		elseif($action == "err")
		{
...
if ($gmwfb_error_found == TRUE && isset($gmwfb_errors[0]) == TRUE)
{
	...
	<div class="error fade">
		<p><strong><?php echo $gmwfb_errors[0]; ?></strong></p>
	</div>
	<?php
}
if ($gmwfb_error_found == FALSE && strlen($gmwfb_success) > 0)
{
	...
	<div class="updated fade">
		<p><strong><?php echo $gmwfb_success; ?> <a href="<?php echo GMWFB_ADMINURL; ?>"><?php _e('Click here', 'google-map-with-fancybox-popup'); ?></a> 
		<?php _e('to view the details', 'google-map-with-fancybox-popup'); ?></strong></p>
	</div>
	<?php
}

$googlemap_address = isset($_POST['googlemap_address']) ? $_POST['googlemap_address'] : '';
$googlemap_latitude = isset($_POST['googlemap_address']) ? $_POST['googlemap_latitude'] : '';
$googlemap_longitude = isset($_POST['googlemap_longitude']) ? $_POST['googlemap_longitude'] : '';
?>
...
<div class="form-wrap">
	...
	<form name="gmwfb_form" method="post" action="#" onsubmit="return _gmwfb_submit()"  >
      <h3><?php _e('Add details', 'google-map-with-fancybox-popup'); ?></h3>
		...
		<input name="gmwfb_heading" type="text" id="gmwfb_heading" value="" size="70" maxlength="255" />
		...
		<input type="text" name="googlemap_address" id="googlemap_address" size="60" value="<?php echo $googlemap_address; ?>" />
		...
		<input name="gmwfb_message" type="text" id="gmwfb_message" value="" size="40" maxlength="255" />
		...
		<select name="gmwfb_layers" id="gmwfb_layers">
			<option value='TrafficLayer'>Traffic Layers</option>
			<option value='TransitLayer'>Transit Layers</option>
			<option value='BicyclingLayer'>Bicycling Layers</option>
			<option value='PanoramioLayer'>Panoramio Layers</option>
		</select>
	  ...
	  <input type="hidden" name="wp_create_nonce" id="wp_create_nonce" value="<?php echo wp_create_nonce( 'gmwfb-add-nonce' ); ?>"/>
    </form>
</div>
