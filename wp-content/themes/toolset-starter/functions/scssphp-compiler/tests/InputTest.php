...
class InputTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->scss->addImportPath(dirname(__FILE__) . '/' . self::$inputDir);
    }
    ...
    {
        $files = glob(dirname(__FILE__) . '/' . self::$inputDir . '/' . $pattern);
